...
NEURAL TRANSFER WITH PYTORCH 0.4.0

https://arxiv.org/pdf/1508.06576.pdf

The Neural-Style, or Neural-Transfer, is an algorithm that takes as input
a content-image (e.g. a tortle), a style-image (e.g. artistic waves) and return
the content of the content-image as if it was ‘painted’ using the artistic
...
Main steps contains:
    ...
    #### DATA PREPARATION
    1. Switching to CUDA if avaiable
    2. Loading images
    3. Displaying images
...
# reat PIL images and transform into torch tensors
...
def get_style_model_and_losses(cnn, normalization_mean, normalization_std,
    ...
    for layer in cnn.children():
        if isinstance(layer, nn.Conv2d):
            ...
            # ContentLoss and StyleLoss we insert below. So we replace with
            # out-of-place ones here.
